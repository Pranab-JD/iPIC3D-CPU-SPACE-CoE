...
/** prepare Edge Z for communication: these are communicated in Y direction */
...
void makeNodeGhostEdgeZ(int nx, int ny, int nz, double *faceXleft, double *faceXright, double *ghostXrightYrightZsameEdge, double *ghostXleftYleftZsameEdge, double *ghostXrightYleftZsameEdge, double *ghostXleftYrightZsameEdge) {
  int counter = 0;
  int counterLeft = 0;
  int counterRight = 0;
  for (int j = 1; j < ny - 1; j++)
...
/** prepare Edge Y for communication: these are communicated in X direction */
...
void makeNodeGhostEdgeY(int nx, int ny, int nz, double *faceZleft, double *faceZright, double *ghostXrightYsameZrightEdge, double *ghostXleftYsameZleftEdge, double *ghostXleftYsameZrightEdge, double *ghostXrightYsameZleftEdge) {
  int counter = 0;
  int counterLeft = 0;
  int counterRight = 0;
  for (int i = 1; i < nx - 1; i++)
...
/** prepare Edge X for communication: these are communicated in  Z direction*/
...
void makeNodeGhostEdgeX(int nx, int ny, int nz, double *faceYleft, double *faceYright, double *ghostXsameYrightZrightEdge, double *ghostXsameYleftZleftEdge, double *ghostXsameYleftZrightEdge, double *ghostXsameYrightZleftEdge) {
  int counter = 0;
  int counterLeft = 0;
  int counterRight = 0;
  for (int i = 1; i < nx - 1; i++)
...
// ///////////////////////////
// ///////////////////////////
/** prepare corners for communication */
...
/** prepare ghost corners for communication */
void makeNodeGhostCorner(int nx, int ny, int nz, double *ghostXsameYrightZrightEdge, double *ghostXsameYleftZleftEdge, double *ghostXsameYleftZrightEdge, double *ghostXsameYrightZleftEdge, double *ghostXrightYrightZrightCorner, double *ghostXleftYrightZrightCorner, double *ghostXrightYleftZrightCorner, double *ghostXleftYleftZrightCorner, double *ghostXrightYrightZleftCorner, double *ghostXleftYrightZleftCorner, double *ghostXrightYleftZleftCorner, double *ghostXleftYleftZleftCorner) {
  *ghostXleftYrightZrightCorner  = ghostXsameYrightZrightEdge[1];
  *ghostXrightYrightZrightCorner = ghostXsameYrightZrightEdge[nx - 4];

  *ghostXleftYleftZrightCorner  = ghostXsameYleftZrightEdge[1];
  *ghostXrightYleftZrightCorner = ghostXsameYleftZrightEdge[nx - 4];

  *ghostXleftYrightZleftCorner  = ghostXsameYrightZleftEdge[1];
  *ghostXrightYrightZleftCorner = ghostXsameYrightZleftEdge[nx - 4];

  *ghostXleftYleftZleftCorner  = ghostXsameYleftZleftEdge[1];
  *ghostXrightYleftZleftCorner = ghostXsameYleftZleftEdge[nx - 4];
}
// /////////////////////////////
// ////////////////////////////
// PARSE
...
/** add the values of ghost cells faces to the 3D phisical vector */
void addFace(int nx, int ny, int nz, double ****vector, int ns, double *ghostXrightFace, double *ghostXleftFace, double *ghostYrightFace, double *ghostYleftFace, double *ghostZrightFace, double *ghostZleftFace, const VirtualTopology3D *vct) {
  int counter;
  if (vct->getXright_neighbor_P() != MPI_PROC_NULL) { // XRIGHT
    counter = 0;
    for (int j = 1; j < ny - 1; j++)
...
/** insert the ghost cells Edge Z in the 3D phisical vector */
void addEdgeZ(int nx, int ny, int nz, double ****vector, int ns, double *ghostXrightYrightZsameEdge, double *ghostXleftYleftZsameEdge, double *ghostXrightYleftZsameEdge, double *ghostXleftYrightZsameEdge, const VirtualTopology3D *vct) {
...
void addEdgeY(int nx, int ny, int nz, double ****vector, int ns, double *ghostXrightYsameZrightEdge, double *ghostXleftYsameZleftEdge, double *ghostXleftYsameZrightEdge, double *ghostXrightYsameZleftEdge, const VirtualTopology3D *vct) {
  if (vct->getXright_neighbor_P() != MPI_PROC_NULL && vct->getZright_neighbor_P() != MPI_PROC_NULL) {
    for (int i = 1; i < (ny - 1); i++)
...
/** add the ghost values Edge X to the 3D phisical vector */
void addEdgeX(int nx, int ny, int nz, double ****vector, int ns, double *ghostXsameYrightZrightEdge, double *ghostXsameYleftZleftEdge, double *ghostXsameYleftZrightEdge, double *ghostXsameYrightZleftEdge, const VirtualTopology3D *vct) {
  if (vct->getYright_neighbor_P() != MPI_PROC_NULL && vct->getZright_neighbor_P() != MPI_PROC_NULL) {
    for (int i = 1; i < (nx - 1); i++)
